...
import com.company.benefit.databinding.ActivityAdpopcornBinding
...
class AdPopcornActivity : AppCompatActivity() {

    private lateinit var binding: ActivityAdpopcornBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAdpopcornBinding.inflate(layoutInflater)
         ...
         *
         */
        Adpopcorn.setUserId(applicationContext,"suHobXlBY2NvdW50X25hbWU")
        // 잠금화면에서의 오퍼월 광고 노출
        AdpopcornExtension.useFlagShowWhenLocked(this,true)
        // 고객센터 노출
        /**
        ...
        // 피드형 타입 오퍼월 광고 노출
        Adpopcorn.openFeedOfferWall(this)
        // 간편적립 타입 오퍼월 광고 노출
        //Adpopcorn.openCPMOfferwall(this)


        // 오퍼월 개인 정보 수집 동의 및 종료에 대한 이벤트 리스너를 제공
        Adpopcorn.setEventListener(applicationContext, object : IAdPOPcornEventListener{
        ...
        // 오퍼월 적립 가능 리워드 정보 조회
        AdpopcornExtension.getEarnableTotalRewardInfo(this) { queryResult, totalCount, totalReward -> // queryResult : 조회결과, totalCount : 참여 가능한 캠페인 수
        ...
        AdpopcornExtension.setClientRewardCallbackListener(this, object : IAPClientRewardCallbackListener{
